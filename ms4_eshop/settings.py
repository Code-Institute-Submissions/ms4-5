"""
Django settings for ms4_eshop project.
...
ACOUNT_EMAIL_VERIFICATION = 'mandatory'
ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE = True
ACCOUNT_USERNAME_MIN_LENGTH = 4
LOGIN_URL = '/sccounts/login/'
LOGIN_REDIRECT_URL = '/'

WSGI_APPLICATION = 'ms4_eshop.wsgi.application'
